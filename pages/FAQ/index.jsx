      ...
      <div className="f-container">
        <div className="faq">
          ...
          <p>
            ...
            produto desde que ele esteja contido em um texto que necessariamente
            traga um conteúdo útil para o leitor e não seja uma mera propaganda.
          </p>
          ...
          <p>
            ...
            dimensões do blog (200x500). O banner deve ser fornecido em formato
            PNG ou JPG. Ele permancerá no blog por 30 dias e será removido após
            esse período ou até o dia evento se for o caso.
          </p>
          ...
          <p>
            ...
            site não registra nenhum dado seu salvo excessão se houver submetido
            seu e-mail a alguma lista newsletter.
          </p>
          <h1 id="remoção">Remoção de Conteúdo</h1>
          <h3>Eu posso ter meu conteúdo removido?</h3>
          <p>
            Se for constado que seu material é de autoria de outra pessoa ou não
            credita devidamente ao autor ele pode ser retirado imediatamente e
            sem consulta.
          </p>
          <h3>Este site possui material autoral meu.</h3>
          <p>
            Caso identifique algum produto, marca ou texto que não deveria estar
            sendo publicado aqui, entre imediatamente em contato para a remoção
            do conteúdo ou ajustes para creditar devidamente o autor caso isso
            seja possível.
          </p>
          ...
          <p>
            ...
            idenficar a melhor maneira de corrigir isso, seja retirando o texto
            ou modificando.
          </p>
          <h1 id="compartilhamento">Compartilhamento</h1>
          <h3>Eu posso compartilhar o conteúdo do site?</h3>
          <p>
            Pode sim, desde que use as ferramentas do site para fazê-lo trazendo
            sua audiência para esse site.Caso esteja divulgando em algum veículo
            que não possa ser compartilhadoo através das ferramentas desse site,
            inclua o nome do autor e o site na poostagem.
          </p>
          <h3>
          ...
          <p>
            ...
            Se precisar usar trechos de texto (quotes) coloque o nome doo autor
            com um link para o site.{" "}
          </p>
        </div>
